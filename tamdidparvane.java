...
/*
 * Created by JFormDesigner on Sat Oct 21 04:54:08 PDT 2017
 */
 ...
 */
public class tamdidparvane extends JFrame {
    int mainId;
     SimpleDateFormat formatter = new SimpleDateFormat("yyyy/MM/dd");
    public tamdidparvane(int mainId) {
         this.mainId=mainId;
        initComponents();
    }
   private void initComponents() {
        ...
        //======== panel1 ========
        {
            ...
            //---- label48 ----
            label48.setText("\u062a\u0627\u0631\u06cc\u062e \u062a\u0645\u062f\u06cc\u062f:");
            label48.setFont(new Font("B Zar", Font.PLAIN, 20));
            label48.setForeground(Color.black);
                    ...
                    .addGroup(panel1Layout.createSequentialGroup()
                        ...
                        .addGroup(panel1Layout.createParallelGroup()
                            ...
                            .addGroup(panel1Layout.createSequentialGroup()
                                ...
                                .addComponent(textField88, GroupLayout.PREFERRED_SIZE, 153, GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
   ...
   public JPanel panel1;
    ...
    String bank=comboBox5.getSelectedItem().toString();
       ...
       if  (! textField88.getText().equals("") )
      {
             try
        {
                parvaneDate=formatter.parse(textField88.getText());
        }
           catch(Exception ee){}
      }
      
        manageEng ME=new manageEng();
        String kind="تمدید پروانه";
        ME.saveFinanceAsTamdid(id,value,pay,regDate,payDate,paykind,fishnumber,checknumber,bank,extra,kind,parvaneDate);
