...
/*
 * Created by JFormDesigner on Sat Oct 21 05:13:17 PDT 2017
 */




public class taghirpaye extends JFrame {
    int mainId;
      SimpleDateFormat formatter = new SimpleDateFormat("yyyy/MM/dd");
    public taghirpaye(int mainId) {
         this.mainId=mainId;
        initComponents();
    }
  ...
  private void initComponents() {
        ...
        //======== panel1 ========
        {
            ...
            comboBox4.setModel(new DefaultComboBoxModel<>(new String[] {
              ...
              comboBox4.setFont(new Font("B Zar", Font.PLAIN, 20));
                                    ...
                                    .addGroup(panel1Layout.createParallelGroup()
                                        ...
                                        .addGroup(GroupLayout.Alignment.TRAILING, panel1Layout.createSequentialGroup()
                                            ...
                                            .addGroup(panel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                                ...
                                                .addComponent(comboBox4, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 141, Short.MAX_VALUE))
                                            .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)))
                                    .addGroup(panel1Layout.createSequentialGroup()
                    ...
                    .addGroup(panel1Layout.createSequentialGroup()
                        ...
                        .addGroup(panel1Layout.createParallelGroup()
                            ...
                            .addGroup(panel1Layout.createSequentialGroup()
                                .addGap(12, 12, 12)
                                .addGroup(panel1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                                    .addComponent(comboBox4, GroupLayout.PREFERRED_SIZE, 43, GroupLayout.PREFERRED_SIZE)
                                    .addComponent(label34))
    ...
    private void actionPerformed7(ActionEvent e) {
      ...
      {
         value=Integer.parseInt(textField83.getText());
       }
    ...
    String bank=comboBox5.getSelectedItem().toString();
      ...
      String paye=comboBox4.getSelectedItem().toString();
        
           
      
        manageEng ME=new manageEng();
        String kind="تغییر پایه";
        ME.saveFinanceAsTaghir(id,value,pay,regDate,payDate,paykind,fishnumber,checknumber,bank,extra,kind,paye);
    }
}
