...
import nezam.Main;
/*
 * Created by JFormDesigner on Sat Mar 17 06:05:30 PDT 2018
 */
 ...
 */
public class sahmiye extends JFrame {
    public sahmiye() {
        initComponents();
    }
   ...
   private void initComponents() {
    ...
    private void actionPerformed14(ActionEvent e) {
        ...
        manageEng me=new manageEng();
            String kind=comboBox1.getSelectedItem().toString();
            String entire=textField43.getText();
            String part=textField44.getText();
            String year=textField45.getText();
            String loc=textField46.getText();
            int idmain=Integer.parseInt(textField47.getText());
            me.saveSahmiye(entire,part,year,loc,kind,idmain);
