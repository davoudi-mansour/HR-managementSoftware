...
import nezam.Main;
/*
 * Created by JFormDesigner on Sat Oct 21 01:59:00 PDT 2017
 */
 ...
 */
public class ozviyatAll extends JFrame {
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy/MM/dd");
        
    public ozviyatAll(){ initComponents();}
  ...
  public void initComponents() {
    ...
    private void actionPerformed7(ActionEvent e) {
        ...
        java.util.List eng=me.listData();
        ArrayList <Main> temp=new ArrayList<>();
       for(int j=0;j<eng.size();j++)
      {
            Main user=(Main)eng.get(j);
            
            if(user.getOzviyattype()!= null){
          
            if( user.getOzviyattype().equals("فعال") )
    ...
    String bank=comboBox5.getSelectedItem().toString();
      ...
      String extra=textArea1.getText();
        ...
        manageEng ME=new manageEng();
        String kind="عضویت سالیانه";
        ME.saveFinance(id,value,pay,regDate,payDate,paykind,fishnumber,checknumber,bank,extra,kind);
